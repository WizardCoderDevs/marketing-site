    ...
    <section className="py-20 bg-violet-50 dark:bg-violet-900/30">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-poppins font-bold text-slate-900 dark:text-white mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Serviços Card */}
          <div className="bg-white dark:bg-slate-900 rounded-lg p-8 text-center shadow-lg">
