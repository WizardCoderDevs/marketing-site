          ...
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-green-50 rounded-2xl p-8 border border-green-100">
                ...
                <p className="text-gray-700">
                  ProDentim repopulates your mouth with good bacteria and provides a
                  healthy environment for these strains to grow. It is the only formula in
                  the world with 3.5 billion probiotics specifically developed for oral
                  health.
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8 border border-green-100">
                ...
                <p className="text-gray-600">
                  ...
                  unexpected spice and herb blends from your kitchen that can work
                  wonders.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8 border border-green-100">
                ...
                <p className="text-gray-600">
                  Discover everything about the simple 10-second &ldquo;Bright
                  Teeth&rdquo; method you can do now. You will also discover a
                  little-known brushing trick that is very popular among celebrities and
                  much more!
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto max-w-4xl text-center">
            <div className="bg-white rounded-3xl p-12 shadow-2xl border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                not impressed by the transformation of your gums and teeth or do not
                admire your Hollywood star smile, then at any time in the next 60 days
                write to us and we will refund every penny.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-green-600 to-green-700">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl text-green-100 mb-8">
              Join over 95,000 people who have already experienced the benefits of
              ProDentim
            </p>
        ...
        <footer className="bg-gray-900 text-white py-12 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
              <p>
                © 2024 ProDentim. All rights reserved. The statements on this site have
