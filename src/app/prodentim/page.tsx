...
export default function ProDentimPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-1 text-yellow-500">
                ...
                <FaStar className="w-5 h-5 fill-current" />
                <FaStar className="w-5 h-5 fill-current" />
                <span className="text-gray-600 dark:text-gray-300 ml-2">4.9/5</span>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <span className="inline-block bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 py-2 rounded-full text-sm font-semibold">
            ...
            <div className="relative">
              <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-2xl">
                <div className="text-center space-y-6">
                  <div className="w-32 h-32 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full mx-auto flex items-center justify-center">
                    <span className="text-white text-4xl font-bold">3.5B</span>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
                    Billions of Probiotics
                  </h3>
                  <p className="text-gray-600 dark:text-gray-300">
                    The only formula in the world with this concentration of beneficial
              ...
              <div className="absolute -bottom-4 -left-4 bg-green-500 text-white px-4 py-2 rounded-full font-bold text-sm">
                CLINICALLY TESTED
              </div>
            </div>
          </div>
      ...
      {/* Ingredients Section */}
      <section className="py-16 px-4 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800">
        <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Helps maintain teeth whitening
                    </p>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-white">Mint</h4>
                    <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-700 dark:to-slate-600 rounded-xl p-6 text-center"
              >
      ...
      <section className="py-16 px-4 bg-white dark:bg-slate-800">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* 1 Bottle */}
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-700 dark:to-slate-600 rounded-2xl p-8 relative">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">30 days supply</p>
            ...
            <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-8 relative transform scale-105">
              ...
              <p className="text-blue-100 mb-6">180 days supply</p>
              ...
              <button className="w-full bg-white text-blue-600 py-3 px-6 rounded-xl font-semibold hover:bg-gray-100 transition-colors">
                Buy Now
              </button>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-700 dark:to-slate-600 rounded-2xl p-8 relative">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">90 days supply</p>
              <button className="w-full bg-gray-500 text-white py-3 px-6 rounded-xl font-semibold hover:bg-gray-600 transition-colors">
                Buy Now
              </button>
            </div>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                <span className="line-through text-gray-400">RRP - $109</span> Today:{' '}
                <strong className="text-purple-600">FREE</strong>
              </p>
              <p className="text-gray-600 dark:text-gray-300">
      ...
      {/* Guarantee Section */}
      <section className="py-16 px-4 bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/20 dark:to-emerald-900/20">
        <div className="container mx-auto max-w-4xl text-center">
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="bg-white text-blue-600 py-4 px-8 rounded-xl font-bold text-lg hover:bg-gray-100 transition-colors">
              Buy ProDentim Now
            </button>
